...
# pixl - add amd, freedreno, intel_hasvk & panfrost
# Vulkan Drivers
...
# pixl - shared-glapi is deprecated
...
ifneq ($(BR2_PACKAGE_RECALBOX_TARGET_WSL),y)
...
# pixl - remove	-Dgallium-vdpau=disabled
