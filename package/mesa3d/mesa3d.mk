...
#
################################################################################
# pixL (update) - patch 5 not needed
...
ifeq ($(BR2_PACKAGE_pixL_TARGET_BCM2711)$(BR2_PACKAGE_pixL_PANFROST_MESA3D),y)
...
ifneq ($(BR2_PACKAGE_pixL_TARGET_WSL),y)
